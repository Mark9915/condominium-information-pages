...
if (!$res['success']) {
    ...
    if (isset($_POST['neved'])    && preg_match("/^.{1,40}$/", $_POST['neved']) &&
		...
		mail ($send_to_email, 'Vízóra állás leadás', "N\xE9v: $kuldo_neve\r\nEmail: $kuldo_email \r\nH\xE1zsz\xE1m: $kuldo_haz Emelet: $kuldo_emelet Ajt\xF3: $kuldo_ajto \r\nHideg v\xEDz\xF3ra 1 gy\xE1ri sz\xE1m: $kuldo_gyhideg \r\nHideg v\xEDz\xF3ra 1 \xE1ll\xE1s: $kuldo_hideg \r\nHideg v\xEDz\xF3ra 2 gy\xE1ri sz\xE1m: $kuldo_mashideg \r\nHideg v\xEDz\xF3ra 2 \xE1ll\xE1s: $kuldo_allhideg\r\nMeleg v\xEDz\xF3ra  1 gy\xE1ri sz\xE1m: $kuldo_gymeleg \r\nMeleg v\xEDz\xF3ra 1 \xE1ll\xE1s: $kuldo_meleg  r\nMeleg v\xEDz\xF3ra 2 gy\xE1ri sz\xE1m: $kuldo_masmeleg \r\nMeleg v\xEDz\xF3ra 2 \xE1ll\xE1s: $kuldo_allmeleg  \n" . date('Y/m/d H:i:s'), "FROM: $kuldo_email ");
