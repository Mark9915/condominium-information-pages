<html>
 ...
 <body bgcolor=#eeeeee>
		...
		mail ('tarsasfaludi@gmail.com', 'Vízóra állás leadás', "Név: $kuldo_neve\r\nEmail: $kuldo_email \r\nHázszám: $kuldo_haz Emelet: $kuldo_emelet Ajtó: $kuldo_ajto \r\nMeleg1 vízóra gyári szám: $kuldo_gyhideg \r\nMeleg1 vízóra állás: $kuldo_hideg \r\nMeleg2 vízóra gyári szám: $kuldo_gymeleg \r\nMeleg2 vízóra állás: $kuldo_meleg  \n" . date('Y/m/d H:i:s'), "FROM: $kuldo_email "); }
		else 
		{ 
   ...
   <p style="font:italic 12 verdana;text-align:center">
     <a href="javascript:history.back()">Vízóra állását és a visszaigazolást elküldtük.....<br><br>Tovább</a></p>
 </body>
