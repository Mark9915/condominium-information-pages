<html>
  <head>
	...
	<meta name="Author" content="Óbuda22 Röhling Béla">
  </head>
 <body bgcolor=#bebebe>
		<?php 
		...
		mail ('22obuda@gmail.com', 'Üzenet a honlapról', "Név: $kuldo_neve \r\nEmail: $kuldo_email \r\nÜzenet: $kuldo_comment \r\n" . date('Y/m/d H:i:s'), "FROM: $kuldo_email "); } 
		else 
		{ 
		...
		$kuldo_email = $_POST['email']; 
		$kuldo_comment = $_POST['szoveg']; 
		mail ($kuldo_email, 'Üzenet Óbuda 22 Lakásszövetkezetnek', "Név: $kuldo_neve \r\nEmail: $kuldo_email \r\nÜzenet: $kuldo_comment \r\n" . date('Y/m/d H:i:s'), "FROM: 22obuda@gmail.com  "); } 
		else 
		{ 
		echo ('Nem toltotted ki az osszes mezot'); 
		} 
